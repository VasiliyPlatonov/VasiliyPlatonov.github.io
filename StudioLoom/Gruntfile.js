module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    cssmin: {
      style: {
        files: {
          'css/style.min.css': ['css/unCssStyle.css']
        }
      }
    },
    ...
    sprite: {
      style: {
        src: 'img/*.png', //путь до картинок
        dest: 'img/spritesheet.png', // путь куда положить результат
        destCss: 'css/sprites.css' // путь куда положить css результата
      }
    },
